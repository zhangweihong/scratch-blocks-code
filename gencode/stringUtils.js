 ...
 */
 Blockly.stringUtils = {}
 Blockly.stringUtils.startsWith = function(str, prefix) {
    console.warn('Blockly.utils.string.startsWith()', 'April 2022', 'April 2023', 'Use built-in string.startsWith');
 ...
 */
 Blockly.stringUtils.shortestStringLength= function(array) {
    if (!array.length) {
        return 0;
    }
    return array
 ...
 */
 Blockly.stringUtils.commonWordPrefix= function(array, opt_shortest) {
    if (!array.length) {
        return 0;
    }
 ...
 */
 Blockly.stringUtils.commonWordSuffix= function(array, opt_shortest) {
    if (!array.length) {
        return 0;
    }
    else if (array.length === 1) {
 ...
 */
 Blockly.stringUtils.wrap= function(text, limit) {
 ...
 */
 Blockly.stringUtils.isNumber = function(str) {
